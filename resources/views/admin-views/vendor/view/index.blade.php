        ...
        <div class="col-md-4">
            <div class="card h-100 card--bg-1">
                ...
                <div class="card-footer pt-0 bg-transparent border-0">
                        <a class="btn text-white text-capitalize bg--title h--45px w-100" href="{{$store->vendor->status ? route('admin.account-transaction.index') : '#'}}" title="{{translate('messages.goto')}} {{translate('messages.account_transaction')}}">{{translate('messages.collect_cash_from_store')}}</a>
                </div>
            </div>
        </div>
        <div class="col-md-8">
