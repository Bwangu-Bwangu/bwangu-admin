        ...
        <div class="card">
            ...
            <div class="card-header border-0  py-2">
                <div class="search--button-wrapper justify-content-end">
                    <form action="{{ route('admin.customer.list') }}" id="search-form" class="search-form">
                        <!-- Search -->
                        <div class="input-group input--group">
                            ...
                            {{-- @if (request()->get('search'))
                                <button type="reset" class="btn btn-info mx-1 py-1 min-height-40"
                                    onclick="location.href = '{{ route('admin.customer.list') }}'">{{ translate('messages.reset') }}</button>
                            @endif --}}
                        </div>
                        <!-- End Search -->
                    </form>
                            ...
                            @foreach ($customers as $key => $customer)
                                <tr class="">
                                    ...
                                    <td class="table-column-pl-0">
                                        <a href="{{ route('admin.customer.view', [$customer['id']]) }}" class="text--hover">
                                    ...
                                    <td>
                                        <label class="toggle-switch toggle-switch-sm ml-xl-4" for="stocksCheckbox{{ $customer->id }}">
                                            <input type="checkbox"
                                                onclick="status_change_alert('{{ route('admin.customer.status', [$customer->id, $customer->status ? 0 : 1]) }}', '{{ $customer->status? translate('messages.you_want_to_block_this_customer'): translate('messages.you_want_to_unblock_this_customer') }}', event)"
