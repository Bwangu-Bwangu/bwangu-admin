...
<!--excite-->
            <div class="col-md-6">
                <div class="card h-100">
                    <div class="card-body">
                        @php($config=\App\CentralLogics\Helpers::get_business_settings('excite_sms'))
                        <form class="sms-module-form" action="{{env('APP_MODE')!='demo'?route('admin.business-settings.sms-module-update',['excite_sms']):'javascript:'}}"
                              method="post">
                            @csrf
                            <div>
                                <h5 class="d-flex flex-wrap justify-content-between align-items-center text-uppercase">
                                    <span>{{translate('messages.excite_sms')}}</span>
                                    <div class="pl-2">
                                        <img src="{{asset('public/assets/admin/img/msg91.png')}}" alt="public" width="38px" height="38px">
                                    </div>
                                </h5>
                                ...
                                <div class="form-group">
                                    <label class="form-label text-capitalize"
                                        >{{translate('messages.sender_id')}}</label>
                                    <input type="text" class="form-control" name="sender_id"
                                        value="{{env('APP_MODE')!='demo'?$config['sender_id']??"":''}}">
                                </div>
                                <div class="form-group">
                                    <label class="form-label text-capitalize"
                                        >{{translate('messages.authkey')}}</label>
